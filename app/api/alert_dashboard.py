...
MOCK_KPI_DATA = {
    ...
    "monthlySalesAmount": {"val": 4823.56, "trendVal": 6.2},
    "monthlySalesQty": {"val": 1247, "trendVal": 8.2},
    "alertCount": {"val": 42, "trendVal": 12},
    "alertExecCount": {"val": 18, "trendVal": 6},
}
...
# ==================== 需求预测表 ====================
MOCK_FORECAST_MONTHS = ["2025-07", "2025-08", "2025-09", "2025-10", "2025-11", "2025-12"]
...
@router.get("/alert-dashboard/logistics")
async def get_logistics_data():
    """获取物流动态数据"""
    return MOCK_LOGISTICS_DATA


@router.get("/alert-dashboard/forecast")
async def get_forecast_data():
    """获取需求预测数据"""
    return {"months": MOCK_FORECAST_MONTHS, "data": MOCK_FORECAST_DATA}


@router.get("/alert-dashboard/map")
async def get_map_data():
    """获取地图数据"""
    return {"nodes": MOCK_MAP_NODES, "routes": MOCK_MAP_ROUTES}


@router.get("/alert-dashboard/alerts")
async def get_alert_messages():
    """获取预警消息数据"""
    return MOCK_ALERT_MESSAGES
