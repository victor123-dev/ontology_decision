...
export const enUS: Translations = {
  ...
  welcome: {
    ...
    description:
      "Welcome to ✨ ZhiTi, an ontology-based decision support system. With built-in and custom skills, ZhiTi helps you make intelligent decisions, analyze data, and provide professional decision recommendations.",

    createYourOwnSkill: "Create Your Own Skill",
    createYourOwnSkillDescription:
      "Create your own skill to release the power of ZhiTi. With customized skills,\nZhiTi can help you make intelligent decisions, analyze data, and provide\n professional decision recommendations.",
  },
  ...
  agents: {
    ...
    saving: "Saving agent...",
    saveRequested:
      "Save requested. ZhiTi is generating and saving an initial version now.",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "The agent was created, but ZhiTi could not load it yet. Please refresh this page in a moment.",
    more: "More actions",
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription:
      "Navigate ZhiTi faster with keyboard shortcuts.",
  ...
  settings: {
    title: "Settings",
    description: "Adjust how ZhiTi looks and behaves for you.",
    sections: {
    ...
    memory: {
      title: "Memory",
      description:
        "ZhiTi automatically learns from your conversations in the background. These memories help ZhiTi understand you better and deliver a more personalized experience.",
