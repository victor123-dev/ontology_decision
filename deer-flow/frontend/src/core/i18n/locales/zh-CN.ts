...
export const zhCN: Translations = {
  ...
  welcome: {
    greeting: "你好，欢迎回来！",
    description:
      "欢迎使用 ✨ 智体，一个基于本体的决策支持系统。通过内置和自定义的 Skills，\n智体可以帮助您进行智能决策、分析数据，并提供专业的决策建议。",

    createYourOwnSkill: "创建你自己的 Agent SKill",
    createYourOwnSkillDescription:
      "创建您的 Agent Skill 来释放智体的潜力。通过自定义技能，智体\n可以帮助您进行智能决策、分析数据，并提供专业的决策建议。",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription: "使用键盘快捷键更快地操作智体。",
  ...
  settings: {
    ...
    memory: {
      title: "记忆",
      description:
        "智体会在后台不断从您的对话中自动学习。这些记忆能帮助智体更好地理解您，并提供更个性化的体验。",
      empty: "暂无可展示的记忆数据。",
      rawJson: "原始 JSON",
      exportButton: "导出记忆",
      exportSuccess: "记忆已导出",
