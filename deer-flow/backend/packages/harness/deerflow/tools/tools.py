...
def get_available_tools(
    ...
    allowed_groups_from_config = {group.name for group in config.tool_groups} if config.tool_groups is not None else None    
    tool_configs = [tool for tool in config.tools if (groups is None or tool.group in groups) and (allowed_groups_from_config is None or tool.group in allowed_groups_from_config)]
