...
ALL_FIELDS = {
    "product": [
        ...
        {"field_id": "product_type", "data_type": "string", "name": "产品类型", "required": True,  "description": "产品类型（枚举：成品）"},
    ...
    "material": [
        ...
        {"field_id": "material_type", "data_type": "string", "name": "物料类型", "required": True,  "description": "物料类型（枚举：原材料/辅料）"},
        {"field_id": "unit_of_measure", "data_type": "string", "name": "计量单位", "required": False,  "description": "计量单位（如：PCS/片/千克/米）"},
    ...
    "work_center": [
        ...
        {"field_id": "work_center_type", "data_type": "string", "name": "类型", "required": True,  "description": "工作中心类型（枚举：接收/加工/检验/测试/辅助/出货）"},
    ...
    "machine": [
        ...
        {"field_id": "machine_type", "data_type": "string", "name": "机台类型", "required": True,  "description": "机台类型（枚举：自动/半自动/手动）"},
        ...
        {"field_id": "status", "data_type": "string", "name": "状态", "required": False,  "description": "机台状态（枚举：在线/离线/维护中/故障/待机）"},
    ...
    "route_step": [
        ...
        {"field_id": "operation_type", "data_type": "string", "name": "操作类型", "required": False,  "description": "操作类型（枚举：加工/检验）"},
    ...
    "setup_matrix": [
        ...
        {"field_id": "setup_time_minutes", "data_type": "integer", "name": "换线时间(分钟)", "required": False,  "description": "换线/准备时间（单位：分钟）"},
        {"field_id": "setup_type", "data_type": "string", "name": "换线类型", "required": False,  "description": "换线类型（枚举：换模）"},
        {"field_id": "is_active", "data_type": "boolean", "name": "是否激活", "required": False,  "description": "是否启用（True=启用，False=停用）"},
    ],
    "shift_pattern": [
    ...
    "supplier": [
        ...
        {"field_id": "supplier_type", "data_type": "string", "name": "合作类型", "required": False,  "description": "合作类型（枚举：战略合作/直供/进口/备选）"},
    ...
    "material_substitute": [
        ...
        {"field_id": "quality_grade", "data_type": "string", "name": "质量等级", "required": False,  "description": "质量等级（枚举：同等级/略低）"},
        {"field_id": "approval_status", "data_type": "string", "name": "审批状态", "required": False,  "description": "审批状态（枚举：已批准/待审批/已拒绝）"},
    ...
    "bom": [
        ...
        {"field_id": "consumption_pattern", "data_type": "string", "name": "消耗模式", "required": False,  "description": "消耗模式（枚举：工序开始时消耗/按比例消耗）"},
        {"field_id": "version", "data_type": "string", "name": "版本", "required": False,  "description": "版本号（格式：v1.0/v2.0）"},
        {"field_id": "effective_date", "data_type": "date", "name": "生效日期", "required": False,  "description": "生效日期"},
        {"field_id": "expiry_date", "data_type": "date", "name": "失效日期", "required": False,  "description": "失效日期（过期后不可使用）"},
    ],
    "customer": [
        ...
        {"field_id": "customer_level", "data_type": "string", "name": "客户等级", "required": False,  "description": "客户等级（枚举：VIP/重要/普通）"},
        ...
        {"field_id": "region", "data_type": "string", "name": "地区", "required": False,  "description": "地区（枚举：大陆/台湾/欧美/亚太）"},
        {"field_id": "status", "data_type": "string", "name": "状态", "required": False,  "description": "客户状态（枚举：活跃/暂停/关闭）"},
    ...
    "customer_product": [
        ...
        {"field_id": "quality_level", "data_type": "string", "name": "质量等级", "required": False,  "description": "质量等级要求（枚举：标准/车规/工规/军规）"},
        {"field_id": "status", "data_type": "string", "name": "状态", "required": False,  "description": "客户产品关系状态（枚举：有效/已停用）"},
    ],
    "customer_order": [
        ...
        {"field_id": "status", "data_type": "string", "name": "状态", "required": False,  "description": "订单状态（枚举：已确认/部分发货/已发货/已取消/重工中）"},
    ...
    "work_order": [
        ...
        {"field_id": "product_id", "data_type": "string", "name": "产品ID", "required": True,  "description": "产品唯一标识符"},
        {"field_id": "work_order_type", "data_type": "string", "name": "工单类型", "required": False,  "description": "工单类型（枚举：正常/重工）"},
        ...
        {"field_id": "status", "data_type": "string", "name": "状态", "required": False,  "description": "工单状态（枚举：生产中/已完成/已取消）"},
    ...
    "work_order_operation": [
        ...
        {"field_id": "status", "data_type": "string", "name": "状态", "required": False,  "description": "工单工序状态（枚举：已完成/已排程/待开工）"},
    ...
    "work_order_material": [
        ...
        {"field_id": "status", "data_type": "string", "name": "状态", "required": False,  "description": "工单物料状态（枚举：待分配/已消耗/已齐套/已取消/部分分配/缺料）"},
        {"field_id": "note", "data_type": "text", "name": "备注", "required": False,  "description": "备注说明"},
    ],
    "purchase_order": [
        ...
        {"field_id": "status", "data_type": "string", "name": "状态", "required": False,  "description": "采购订单状态（枚举：已入库/已创建）"},
    ...
    "purchase_order_line": [
        ...
        {"field_id": "status", "data_type": "string", "name": "状态", "required": False,  "description": "采购订单行状态（枚举：待收货/部分到货/全部到货）"},
    ...
    "wip_lot": [
        ...
        {"field_id": "lot_status", "data_type": "string", "name": "批次状态", "required": False,  "description": "批次状态（枚举：排队中/加工中/已完成）"},
    ...
    "production_task": [
        ...
        {"field_id": "status", "data_type": "string", "name": "状态", "required": False,  "description": "生产任务状态（枚举：已排程/待执行/执行中/已完成/已取消/已延期）"},
        {"field_id": "note", "data_type": "text", "name": "备注", "required": False,  "description": "备注说明"},
    ],
    "material_transfer": [
        ...
        {"field_id": "status", "data_type": "string", "name": "状态", "required": False,  "description": "调拨单状态（枚举：已执行）"},
    ...
    "inventory_transaction": [
        ...
        {"field_id": "material_id", "data_type": "string", "name": "物料ID", "required": True,  "description": "物料唯一标识符"},
        {"field_id": "transaction_type", "data_type": "string", "name": "事务类型", "required": True,  "description": "事务类型（枚举：出库/IQC入库/取消释放/生产消耗/盘点亏损/盘点盈余/调拨出库/采购入库/预留）"},
    ...
    "quality_inspection": [
        ...
        {"field_id": "inspection_type", "data_type": "string", "name": "检验类型", "required": True,  "description": "检验类型（枚举：FQC出货检验/IQC入料/IQC来料检验/首件检验）"},
        {"field_id": "wo_op_id", "data_type": "string", "name": "工单工序ID", "required": False,  "description": "工单工序唯一标识符"},
        {"field_id": "lot_id", "data_type": "string", "name": "批次ID", "required": False,  "description": "批次唯一标识符"},
        ...
        {"field_id": "related_doc_type", "data_type": "string", "name": "关联单据类型", "required": False,  "description": "关联单据类型（枚举：WorkOrderOperation/PurchaseOrder/CustomerOrder）"},
        ...
        {"field_id": "result", "data_type": "string", "name": "结果", "required": False,  "description": "检验结果（枚举：合格/返工/报废/不合格/让步接收/不合格-部分/拒收部分）"},
    ...
    "machine_status_log": [
        ...
        {"field_id": "status", "data_type": "string", "name": "状态", "required": True,  "description": "机台状态（枚举：恢复/换线/故障/空闲/维护/运行）"},
    ...
    "external_supply_chain_risk": [
        ...
        {"field_id": "title", "data_type": "string", "name": "风险标题", "required": True, "description": "风险事件标题"},
        ...
        {"field_id": "assigned_to", "data_type": "string", "name": "负责人", "required": False, "description": "负责人（处理该风险的责任人）"},
