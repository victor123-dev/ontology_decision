...
ALL_FIELDS = {
    ...
    "customer_order": [
        ...
        {"field_id": "status", "data_type": "VARCHAR(50)", "name": "状态", "required": False,  "description": "订单状态（枚举：已确认/部分发货/已发货/已取消/重工中）"},
    ...
    "work_order": [
        ...
        {"field_id": "status", "data_type": "VARCHAR(50)", "name": "状态", "required": False,  "description": "工单状态（枚举：生产中/已完成/已取消）"},
    ...
    "work_order_operation": [
        ...
        {"field_id": "status", "data_type": "VARCHAR(50)", "name": "状态", "required": False,  "description": "工单工序状态（枚举：已完成/已排程/待开工）"},
    ...
    "work_order_material": [
        ...
        {"field_id": "status", "data_type": "VARCHAR(50)", "name": "状态", "required": False,  "description": "工单物料状态（枚举：待分配/已消耗/已齐套/已取消/部分分配/缺料）"},
        {"field_id": "note", "data_type": "VARCHAR(500)", "name": "备注", "required": False,  "description": "备注说明"},
    ],
    "purchase_order": [
        ...
        {"field_id": "status", "data_type": "VARCHAR(50)", "name": "状态", "required": False,  "description": "采购订单状态（枚举：已入库/已创建）"},
    ...
    "purchase_order_line": [
        ...
        {"field_id": "status", "data_type": "VARCHAR(50)", "name": "状态", "required": False,  "description": "采购订单行状态（枚举：待收货/部分到货/全部到货）"},
    ...
    "wip_lot": [
        ...
        {"field_id": "lot_status", "data_type": "VARCHAR(50)", "name": "批次状态", "required": False,  "description": "批次状态（枚举：排队中/加工中/已完成）"},
    ...
    "material_transfer": [
        ...
        {"field_id": "status", "data_type": "VARCHAR(50)", "name": "状态", "required": False,  "description": "调拨单状态（枚举：已执行）"},
    ...
    "inventory_transaction": [
        ...
        {"field_id": "material_id", "data_type": "VARCHAR(50)", "name": "物料ID", "required": True,  "description": "物料唯一标识符"},
        {"field_id": "transaction_type", "data_type": "VARCHAR(50)", "name": "事务类型", "required": True,  "description": "事务类型（枚举：出库/IQC入库/取消释放/生产消耗/盘点亏损/盘点盈余/调拨出库/采购入库/预留）"},
    ...
    "quality_inspection": [
        ...
        {"field_id": "inspection_type", "data_type": "VARCHAR(50)", "name": "检验类型", "required": True,  "description": "检验类型（枚举：FQC出货检验/IQC入料/IQC来料检验/首件检验）"},
        {"field_id": "wo_op_id", "data_type": "VARCHAR(50)", "name": "工单工序ID", "required": False,  "description": "工单工序唯一标识符"},
        {"field_id": "lot_id", "data_type": "VARCHAR(50)", "name": "批次ID", "required": False,  "description": "批次唯一标识符"},
        ...
        {"field_id": "related_doc_type", "data_type": "VARCHAR(50)", "name": "关联单据类型", "required": False,  "description": "关联单据类型（枚举：WorkOrderOperation/PurchaseOrder/CustomerOrder）"},
        ...
        {"field_id": "result", "data_type": "VARCHAR(50)", "name": "结果", "required": False,  "description": "检验结果（枚举：合格/返工/报废/不合格/让步接收/不合格-部分/拒收部分）"},
    ...
    "machine_status_log": [
        ...
        {"field_id": "status", "data_type": "VARCHAR(50)", "name": "状态", "required": True,  "description": "机台状态（枚举：恢复/换线/故障/空闲/维护/运行）"},
    ...
    "external_supply_chain_risk": [
        ...
        {"field_id": "status", "data_type": "VARCHAR(20)", "name": "处理状态", "description": "风险处理状态（枚举：新发现/分析中/缓解中/已解决/已忽略）", "required": False},
    ...
    "supplier_risk_association": [
        ...
        {"field_id": "supplier_id", "data_type": "VARCHAR(50)", "name": "供应商ID", "required": True,  "description": "供应商唯一标识符"},
        {"field_id": "risk_id", "data_type": "VARCHAR(50)", "name": "风险ID", "required": True,  "description": "风险事件唯一标识符"},
        {"field_id": "association_type", "data_type": "VARCHAR(50)", "name": "关联类型", "description": "关联类型（枚举：直接/间接/潜在）", "required": False},
        {"field_id": "impact_level", "data_type": "VARCHAR(20)", "name": "影响程度", "description": "影响程度（枚举：严重/高/中/低）", "required": False},
        {"field_id": "note", "data_type": "VARCHAR(500)", "name": "备注", "required": False,  "description": "备注说明"},
    ],
}
