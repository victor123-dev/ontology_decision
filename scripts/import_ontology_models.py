...
ALL_FIELDS = {
    ...
    "work_order": [
        ...
        {"field_id": "status", "data_type": "string", "name": "状态", "required": False,  "description": "工单状态（枚举：生产中/已完成/已取消）", "is_enum": True, "enum_values": ["生产中", "已完成", "已取消"]},
    ...
    "work_order_operation": [
        ...
        {"field_id": "status", "data_type": "string", "name": "状态", "required": False,  "description": "工单工序状态（枚举：已完成/已排程/待开工）", "is_enum": True, "enum_values": ["已完成", "已排程", "待开工"]},
    ...
    "purchase_order": [
        ...
        {"field_id": "status", "data_type": "string", "name": "状态", "required": False,  "description": "采购订单状态（枚举：已入库/已创建）", "is_enum": True, "enum_values": ["已入库", "已创建"]},
