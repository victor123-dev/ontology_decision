...
ALL_FIELDS = {
    "product": [
        {"field_id": "product_id", "data_type": "VARCHAR(50)", "name": "产品ID", "required": True,  "description": "产品唯一标识符"},
        {"field_id": "product_name", "data_type": "VARCHAR(100)", "name": "产品名称", "required": True,  "description": "产品名称"},
        {"field_id": "product_type", "data_type": "VARCHAR(50)", "name": "产品类型", "required": True,  "description": "产品类型（枚举：成品）"},
        ...
        {"field_id": "setup_group", "data_type": "VARCHAR(50)", "name": "换线组", "required": False,  "description": "换线组（用于排程优化，同组工单可合并）"},
        {"field_id": "unit_of_measure", "data_type": "VARCHAR(20)", "name": "计量单位", "required": False,  "description": "计量单位（如：PCS/片/千克/米）"},
    ...
    "material": [
        {"field_id": "material_id", "data_type": "VARCHAR(50)", "name": "物料ID", "required": True,  "description": "物料唯一标识符"},
        {"field_id": "material_name", "data_type": "VARCHAR(100)", "name": "物料名称", "required": True,  "description": "物料名称"},
        {"field_id": "material_type", "data_type": "VARCHAR(50)", "name": "物料类型", "required": True,  "description": "物料类型（枚举：原材料/辅料）"},
        {"field_id": "unit_of_measure", "data_type": "VARCHAR(20)", "name": "计量单位", "required": False,  "description": "计量单位（如：PCS/片/千克/米）"},
    ...
    "work_center": [
        {"field_id": "work_center_id", "data_type": "VARCHAR(50)", "name": "工作中心ID", "required": True,  "description": "工作中心唯一标识符（主键）"},
        {"field_id": "work_center_name", "data_type": "VARCHAR(100)", "name": "工作中心名称", "required": True,  "description": "工作中心名称"},
        {"field_id": "work_center_type", "data_type": "VARCHAR(50)", "name": "类型", "required": True,  "description": "工作中心类型（枚举：接收/加工/检验/测试/辅助/出货）"},
        {"field_id": "capacity_uom", "data_type": "VARCHAR(20)", "name": "产能单位", "required": False,  "description": "产能计量单位（如：小时/片/批次）"},
        {"field_id": "is_active", "data_type": "BOOLEAN", "name": "是否激活", "required": False,  "description": "是否启用（True=启用，False=停用）"},
    ],
    "machine": [
        {"field_id": "machine_id", "data_type": "VARCHAR(50)", "name": "机台ID", "required": True,  "description": "机台唯一标识符"},
        {"field_id": "machine_name", "data_type": "VARCHAR(100)", "name": "机台名称", "required": True,  "description": "机台名称"},
        {"field_id": "machine_type", "data_type": "VARCHAR(50)", "name": "机台类型", "required": True,  "description": "机台类型（枚举：自动/半自动/手动）"},
        {"field_id": "work_center_id", "data_type": "VARCHAR(50)", "name": "所属工作中心ID", "required": True,  "description": "所属工作中心ID（外键关联work_center表）"},
        {"field_id": "max_capacity_per_hour", "data_type": "FLOAT", "name": "最大产能(片/小时)", "required": False,  "description": "最大产能（单位：片/小时）"},
        {"field_id": "status", "data_type": "VARCHAR(50)", "name": "状态", "required": False,  "description": "机台状态（枚举：在线/离线/维护中/故障/待机）"},
        {"field_id": "current_product_id", "data_type": "VARCHAR(50)", "name": "当前生产产品ID", "required": False,  "description": "当前加工产品ID"},
        {"field_id": "current_setup_group", "data_type": "VARCHAR(50)", "name": "当前换线组", "required": False,  "description": "当前换线组状态"},
    ...
    "process_route": [
        {"field_id": "route_id", "data_type": "VARCHAR(50)", "name": "路线ID", "required": True,  "description": "工艺路线唯一标识符"},
        {"field_id": "product_id", "data_type": "VARCHAR(50)", "name": "产品ID", "required": True,  "description": "产品唯一标识符"},
        {"field_id": "route_name", "data_type": "VARCHAR(100)", "name": "路线名称", "required": True,  "description": "工艺路线名称"},
        {"field_id": "version", "data_type": "VARCHAR(20)", "name": "版本", "required": False,  "description": "版本号（格式：v1.0/v2.0）"},
        {"field_id": "is_active", "data_type": "BOOLEAN", "name": "是否激活", "required": False,  "description": "是否启用（True=启用，False=停用）"},
    ...
    "route_step": [
        {"field_id": "step_id", "data_type": "VARCHAR(50)", "name": "工序ID", "required": True,  "description": "工序唯一标识符"},
        {"field_id": "route_id", "data_type": "VARCHAR(50)", "name": "所属路线ID", "required": True,  "description": "工艺路线唯一标识符"},
        {"field_id": "sequence_no", "data_type": "INTEGER", "name": "工序序号", "required": True,  "description": "工序序号（执行顺序，从1开始）"},
        {"field_id": "step_name", "data_type": "VARCHAR(100)", "name": "工序名称", "required": True,  "description": "工序名称"},
        {"field_id": "operation_type", "data_type": "VARCHAR(50)", "name": "操作类型", "required": False,  "description": "操作类型（枚举：加工/检验）"},
        {"field_id": "standard_time_hours", "data_type": "FLOAT", "name": "标准工时(小时)", "required": False,  "description": "标准工时（单位：小时）"},
        {"field_id": "machine_type_required", "data_type": "VARCHAR(50)", "name": "所需工作中心ID", "required": True,  "description": "所需机台类型"},
    ...
    "machine_capability": [
        {"field_id": "capability_id", "data_type": "VARCHAR(50)", "name": "能力ID", "required": True,  "description": "能力矩阵唯一标识符"},
        {"field_id": "machine_id", "data_type": "VARCHAR(50)", "name": "机台ID", "required": True,  "description": "机台唯一标识符"},
        {"field_id": "product_id", "data_type": "VARCHAR(50)", "name": "产品ID", "required": True,  "description": "产品唯一标识符"},
    ...
    "setup_matrix": [
        {"field_id": "matrix_id", "data_type": "VARCHAR(50)", "name": "矩阵ID", "required": True,  "description": "换线矩阵唯一标识符"},
        {"field_id": "machine_id", "data_type": "VARCHAR(50)", "name": "机台ID", "required": True,  "description": "机台唯一标识符"},
        {"field_id": "from_product_id", "data_type": "VARCHAR(50)", "name": "切换前产品ID", "required": True,  "description": "切换前产品ID"},
        {"field_id": "to_product_id", "data_type": "VARCHAR(50)", "name": "切换后产品ID", "required": True,  "description": "切换后产品ID"},
        {"field_id": "setup_time_minutes", "data_type": "INTEGER", "name": "换线时间(分钟)", "required": False,  "description": "换线/准备时间（单位：分钟）"},
        {"field_id": "setup_type", "data_type": "VARCHAR(50)", "name": "换线类型", "required": False,  "description": "换线类型（枚举：换模）"},
        {"field_id": "is_active", "data_type": "BOOLEAN", "name": "是否激活", "required": False,  "description": "是否启用（True=启用，False=停用）"},
    ],
    "shift_pattern": [
        {"field_id": "shift_id", "data_type": "VARCHAR(50)", "name": "班次ID", "required": True,  "description": "班次唯一标识符"},
        {"field_id": "shift_name", "data_type": "VARCHAR(50)", "name": "班次名称", "required": True,  "description": "班次名称（如：早班/中班/夜班）"},
        {"field_id": "start_time", "data_type": "VARCHAR(10)", "name": "开始时间", "required": True,  "description": "开始时间（格式：HH:MM，如08:00）"},
        {"field_id": "end_time", "data_type": "VARCHAR(10)", "name": "结束时间", "required": True,  "description": "结束时间（格式：HH:MM，如17:00）"},
        {"field_id": "available_hours", "data_type": "FLOAT", "name": "可用工时", "required": False,  "description": "可用工时（单位：小时）"},
        {"field_id": "efficiency_factor", "data_type": "FLOAT", "name": "效率因子", "required": False,  "description": "效率因子（如1.0表示标准效率，1.2表示120%效率）"},
        {"field_id": "is_active", "data_type": "BOOLEAN", "name": "是否激活", "required": False,  "description": "是否启用（True=启用，False=停用）"},
    ],
    "supplier": [
        {"field_id": "supplier_id", "data_type": "VARCHAR(50)", "name": "供应商ID", "required": True,  "description": "供应商唯一标识符"},
        {"field_id": "supplier_name", "data_type": "VARCHAR(200)", "name": "供应商名称", "required": True,  "description": "供应商名称"},
        {"field_id": "supplier_type", "data_type": "VARCHAR(50)", "name": "合作类型", "required": False,  "description": "合作类型（枚举：战略合作/直供/进口/备选）"},
        {"field_id": "country", "data_type": "VARCHAR(50)", "name": "国家/地区", "required": False,  "description": "国家/地区（如：中国/美国/日本/台湾）"},
        {"field_id": "industry_position", "data_type": "VARCHAR(200)", "name": "行业地位", "required": False,  "description": "行业地位（如：全球前三/国内领先/区域主要供应商）"},
    ...
    "supplier_material": [
        {"field_id": "sm_id", "data_type": "VARCHAR(50)", "name": "关系ID", "required": True,  "description": "供应商物料关系唯一标识符"},
        {"field_id": "supplier_id", "data_type": "VARCHAR(50)", "name": "供应商ID", "required": True,  "description": "供应商唯一标识符"},
        {"field_id": "material_id", "data_type": "VARCHAR(50)", "name": "物料ID", "required": True,  "description": "物料唯一标识符"},
    ...
    "material_substitute": [
        {"field_id": "ms_id", "data_type": "VARCHAR(50)", "name": "替代关系ID", "required": True,  "description": "物料替代关系唯一标识符"},
        {"field_id": "material_id", "data_type": "VARCHAR(50)", "name": "原物料ID", "required": True,  "description": "物料唯一标识符"},
        {"field_id": "substitute_material_id", "data_type": "VARCHAR(50)", "name": "替代物料ID", "required": True,  "description": "替代物料ID"},
        {"field_id": "substitute_priority", "data_type": "INTEGER", "name": "替代优先级", "required": False,  "description": "替代优先级（数字越小优先级越高）"},
        {"field_id": "quality_grade", "data_type": "VARCHAR(50)", "name": "质量等级", "required": False,  "description": "质量等级（枚举：同等级/略低）"},
        {"field_id": "approval_status", "data_type": "VARCHAR(50)", "name": "审批状态", "required": False,  "description": "审批状态（枚举：已批准/待审批/已拒绝）"},
        {"field_id": "cost_delta_percent", "data_type": "FLOAT", "name": "成本差异(%)", "required": False,  "description": "成本差异百分比（正数表示更贵，负数表示更便宜）"},
    ],
    "bom": [
        {"field_id": "bom_id", "data_type": "VARCHAR(50)", "name": "BOM ID", "required": True,  "description": "BOM唯一标识符"},
        {"field_id": "product_id", "data_type": "VARCHAR(50)", "name": "产品ID", "required": True,  "description": "产品唯一标识符"},
        {"field_id": "material_id", "data_type": "VARCHAR(50)", "name": "物料ID", "required": True,  "description": "物料唯一标识符"},
        {"field_id": "step_id", "data_type": "VARCHAR(50)", "name": "消耗工序ID", "required": False,  "description": "工序唯一标识符"},
        ...
        {"field_id": "consumption_pattern", "data_type": "VARCHAR(50)", "name": "消耗模式", "required": False,  "description": "消耗模式（枚举：工序开始时消耗/按比例消耗）"},
        {"field_id": "version", "data_type": "VARCHAR(20)", "name": "版本", "required": False,  "description": "版本号（格式：v1.0/v2.0）"},
        {"field_id": "effective_date", "data_type": "DATE", "name": "生效日期", "required": False,  "description": "生效日期"},
        {"field_id": "expiry_date", "data_type": "DATE", "name": "失效日期", "required": False,  "description": "失效日期（过期后不可使用）"},
    ],
    "customer": [
        {"field_id": "customer_id", "data_type": "VARCHAR(50)", "name": "客户ID", "required": True,  "description": "客户唯一标识符"},
        {"field_id": "customer_name", "data_type": "VARCHAR(200)", "name": "客户名称", "required": True,  "description": "客户名称"},
        {"field_id": "customer_level", "data_type": "VARCHAR(50)", "name": "客户等级", "required": False,  "description": "客户等级（枚举：VIP/重要/普通）"},
        {"field_id": "industry", "data_type": "VARCHAR(100)", "name": "行业类别", "required": False,  "description": "所属行业（如：汽车电子/消费电子/工业控制/通信）"},
        {"field_id": "credit_limit", "data_type": "FLOAT", "name": "信用额度(万元)", "required": False,  "description": "信用额度（单位：万元）"},
        {"field_id": "payment_terms", "data_type": "VARCHAR(100)", "name": "付款条件", "required": False,  "description": "付款条件（如：月结30天/货到付款/预付50%）"},
        {"field_id": "contact_person", "data_type": "VARCHAR(100)", "name": "联系人", "required": False,  "description": "联系人姓名"},
        {"field_id": "contact_phone", "data_type": "VARCHAR(50)", "name": "联系电话", "required": False,  "description": "联系电话"},
        {"field_id": "contact_email", "data_type": "VARCHAR(100)", "name": "联系邮箱", "required": False,  "description": "联系邮箱"},
        {"field_id": "address", "data_type": "VARCHAR(500)", "name": "地址", "required": False,  "description": "地址"},
        {"field_id": "country", "data_type": "VARCHAR(50)", "name": "国家", "required": False,  "description": "国家/地区（如：中国/美国/日本/台湾）"},
        {"field_id": "region", "data_type": "VARCHAR(50)", "name": "地区", "required": False,  "description": "地区（枚举：大陆/台湾/欧美/亚太）"},
        {"field_id": "status", "data_type": "VARCHAR(50)", "name": "状态", "required": False,  "description": "客户状态（枚举：活跃/暂停/关闭）"},
        {"field_id": "note", "data_type": "VARCHAR(500)", "name": "备注", "required": False,  "description": "备注说明"},
    ],
    "customer_product": [
        ...
        {"field_id": "quality_level", "data_type": "VARCHAR(50)", "name": "质量等级", "required": False,  "description": "质量等级要求（枚举：标准/车规/工规/军规）"},
        {"field_id": "status", "data_type": "VARCHAR(50)", "name": "状态", "required": False,  "description": "客户产品关系状态（枚举：有效/已停用）"},
    ],
    "customer_order": [
        {"field_id": "order_id", "data_type": "VARCHAR(50)", "name": "订单ID", "required": True,  "description": "订单唯一标识符"},
        {"field_id": "customer_id", "data_type": "VARCHAR(50)", "name": "客户ID", "required": True,  "description": "客户唯一标识符"},
        {"field_id": "customer_name", "data_type": "VARCHAR(200)", "name": "客户名称", "required": True,  "description": "客户名称"},
        {"field_id": "customer_po_number", "data_type": "VARCHAR(100)", "name": "客户采购订单号", "required": False,  "description": "客户采购订单号（客户方的订单编号）"},
        {"field_id": "product_id", "data_type": "VARCHAR(50)", "name": "产品ID", "required": True,  "description": "产品唯一标识符"},
        ...
        {"field_id": "status", "data_type": "VARCHAR(50)", "name": "状态", "required": False,  "description": "订单状态（枚举：待确认/已确认/生产中/部分发货/已完成/已取消）"},
        {"field_id": "shipping_address", "data_type": "VARCHAR(500)", "name": "发货地址", "required": False,  "description": "收货地址"},
        {"field_id": "quality_requirement", "data_type": "VARCHAR(100)", "name": "质量要求", "required": False,  "description": "质量要求（如：AQL 0.65/零缺陷）"},
        {"field_id": "packaging_requirement", "data_type": "VARCHAR(200)", "name": "包装要求", "required": False,  "description": "包装要求（如：防静电包装/真空包装）"},
        {"field_id": "note", "data_type": "VARCHAR(500)", "name": "备注", "required": False,  "description": "备注说明"},
    ],
    "work_order": [
        {"field_id": "work_order_id", "data_type": "VARCHAR(50)", "name": "工单ID", "required": True,  "description": "工单唯一标识符"},
        {"field_id": "customer_order_id", "data_type": "VARCHAR(50)", "name": "关联订单ID", "required": False,  "description": "关联客户订单ID"},
        {"field_id": "product_id", "data_type": "VARCHAR(50)", "name": "产品ID", "required": True,  "description": "产品唯一标识符"},
        {"field_id": "work_order_type", "data_type": "VARCHAR(50)", "name": "工单类型", "required": False,  "description": "工单类型（枚举：正常/重工）"},
        ...
        {"field_id": "status", "data_type": "VARCHAR(50)", "name": "状态", "required": False,  "description": "工单状态（枚举：已创建/已排程/生产中/已暂停/已完成/已取消）"},
        {"field_id": "priority", "data_type": "INTEGER", "name": "优先级", "required": False,  "description": "工单优先级（继承自订单优先级）"},
        {"field_id": "setup_group", "data_type": "VARCHAR(50)", "name": "换线组", "required": False,  "description": "换线组（用于排程优化，同组工单可合并）"},
        {"field_id": "current_step_id", "data_type": "VARCHAR(50)", "name": "当前工序ID", "required": False,  "description": "当前执行工序ID"},
    ...
    "work_order_operation": [
        {"field_id": "wo_op_id", "data_type": "VARCHAR(50)", "name": "工单工序ID", "required": True,  "description": "工单工序唯一标识符"},
        {"field_id": "work_order_id", "data_type": "VARCHAR(50)", "name": "工单ID", "required": True,  "description": "工单唯一标识符"},
        {"field_id": "step_id", "data_type": "VARCHAR(50)", "name": "工序ID", "required": True,  "description": "工序唯一标识符"},
        {"field_id": "sequence_no", "data_type": "INTEGER", "name": "工序序号", "required": True,  "description": "工序序号（执行顺序，从1开始）"},
        ...
        {"field_id": "assigned_machine_id", "data_type": "VARCHAR(50)", "name": "分配机台ID", "required": False,  "description": "分配机台ID（外键关联machine表）"},
        {"field_id": "status", "data_type": "VARCHAR(50)", "name": "状态", "required": False,  "description": "工单工序状态（枚举：待执行/执行中/已完成/已暂停/已报废）"},
    ...
    "work_order_material": [
        {"field_id": "wom_id", "data_type": "VARCHAR(50)", "name": "工单物料需求ID", "required": True,  "description": "工单物料需求唯一标识符"},
        {"field_id": "work_order_id", "data_type": "VARCHAR(50)", "name": "工单ID", "required": True,  "description": "工单唯一标识符"},
        {"field_id": "wo_op_id", "data_type": "VARCHAR(50)", "name": "工单工序ID", "required": False,  "description": "工单工序唯一标识符"},
        {"field_id": "material_id", "data_type": "VARCHAR(50)", "name": "物料ID", "required": True,  "description": "物料唯一标识符"},
        ...
        {"field_id": "status", "data_type": "VARCHAR(50)", "name": "状态", "required": False,  "description": "工单物料状态（枚举：待分配/已分配/已领用/已消耗/缺料）"},
        {"field_id": "note", "data_type": "VARCHAR(500)", "name": "备注", "required": False,  "description": "备注说明"},
    ],
    "purchase_order": [
        {"field_id": "po_id", "data_type": "VARCHAR(50)", "name": "采购订单ID", "required": True,  "description": "采购订单唯一标识符"},
        {"field_id": "supplier_id", "data_type": "VARCHAR(50)", "name": "供应商ID", "required": True,  "description": "供应商唯一标识符"},
        {"field_id": "order_date", "data_type": "DATETIME", "name": "下单日期", "required": True,  "description": "下单日期"},
        ...
        {"field_id": "status", "data_type": "VARCHAR(50)", "name": "状态", "required": False,  "description": "采购订单状态（枚举：已创建/已下单/部分收货/已完成/已取消）"},
        {"field_id": "total_amount", "data_type": "FLOAT", "name": "总金额", "required": False,  "description": "总金额（单位：元）"},
        {"field_id": "created_by", "data_type": "VARCHAR(50)", "name": "创建者", "required": False,  "description": "创建人（如：SYSTEM/MRP/用户名）"},
        {"field_id": "note", "data_type": "VARCHAR(500)", "name": "备注", "required": False,  "description": "备注说明"},
    ],
    "purchase_order_line": [
        {"field_id": "line_id", "data_type": "VARCHAR(50)", "name": "订单行ID", "required": True,  "description": "唯一标识符（主键）"},
        {"field_id": "po_id", "data_type": "VARCHAR(50)", "name": "采购订单ID", "required": True,  "description": "采购订单唯一标识符"},
        {"field_id": "material_id", "data_type": "VARCHAR(50)", "name": "物料ID", "required": True,  "description": "物料唯一标识符"},
        ...
        {"field_id": "status", "data_type": "VARCHAR(50)", "name": "状态", "required": False,  "description": "采购订单行状态（枚举：待收货/部分收货/已完成）"},
        {"field_id": "related_work_order_id", "data_type": "VARCHAR(50)", "name": "关联工单ID", "required": False,  "description": "关联工单ID"},
        {"field_id": "related_wom_id", "data_type": "VARCHAR(50)", "name": "关联工单物料需求ID", "required": False,  "description": "关联工单物料需求ID"},
    ],
    "wip_lot": [
        {"field_id": "lot_id", "data_type": "VARCHAR(50)", "name": "批次ID", "required": True,  "description": "批次唯一标识符"},
        {"field_id": "work_order_id", "data_type": "VARCHAR(50)", "name": "工单ID", "required": True,  "description": "工单唯一标识符"},
        {"field_id": "product_id", "data_type": "VARCHAR(50)", "name": "产品ID", "required": True,  "description": "产品唯一标识符"},
        {"field_id": "lot_size", "data_type": "FLOAT", "name": "批次大小", "required": False,  "description": "批次大小（标准25片/批）"},
        {"field_id": "current_step_id", "data_type": "VARCHAR(50)", "name": "当前工序ID", "required": False,  "description": "当前执行工序ID"},
        {"field_id": "current_machine_id", "data_type": "VARCHAR(50)", "name": "当前机台ID", "required": False,  "description": "当前加工机台ID（外键关联machine表）"},
        ...
        {"field_id": "lot_status", "data_type": "VARCHAR(50)", "name": "批次状态", "required": False,  "description": "批次状态（枚举：排队中/加工中/已完成/已冻结/已报废）"},
        ...
        {"field_id": "hold_reason", "data_type": "VARCHAR(200)", "name": "Hold原因", "required": False,  "description": "冻结原因（如：待检验/质量问题/客户暂停）"},
        {"field_id": "priority", "data_type": "INTEGER", "name": "优先级", "required": False,  "description": "优先级（数字越小优先级越高，1-10范围）"},
        {"field_id": "created_at", "data_type": "DATETIME", "name": "创建时间", "required": False,  "description": "创建时间（系统自动生成）"},
    ],
    "production_task": [
        {"field_id": "task_id", "data_type": "VARCHAR(50)", "name": "任务ID", "required": True,  "description": "生产任务唯一标识符"},
        {"field_id": "wo_op_id", "data_type": "VARCHAR(50)", "name": "工单工序ID", "required": True,  "description": "工单工序唯一标识符"},
        {"field_id": "work_order_id", "data_type": "VARCHAR(50)", "name": "工单ID", "required": True,  "description": "工单唯一标识符"},
        {"field_id": "machine_id", "data_type": "VARCHAR(50)", "name": "机台ID", "required": True,  "description": "机台唯一标识符"},
        {"field_id": "lot_id", "data_type": "VARCHAR(50)", "name": "批次ID", "required": False,  "description": "批次唯一标识符"},
        ...
        {"field_id": "shift_id", "data_type": "VARCHAR(50)", "name": "班次ID", "required": False,  "description": "班次唯一标识符"},
        {"field_id": "is_night_shift", "data_type": "BOOLEAN", "name": "是否夜班", "required": False,  "description": "是否夜班（True=夜班）"},
        {"field_id": "status", "data_type": "VARCHAR(50)", "name": "状态", "required": False,  "description": "生产任务状态（枚举：已排程/待执行/执行中/已完成/已取消/已延期）"},
        {"field_id": "note", "data_type": "VARCHAR(500)", "name": "备注", "required": False,  "description": "备注说明"},
    ],
    "material_transfer": [
        {"field_id": "transfer_id", "data_type": "VARCHAR(50)", "name": "调拨ID", "required": True,  "description": "调拨单唯一标识符"},
        {"field_id": "material_id", "data_type": "VARCHAR(50)", "name": "物料ID", "required": True,  "description": "物料唯一标识符"},
        {"field_id": "from_work_order_id", "data_type": "VARCHAR(50)", "name": "来源工单ID", "required": False,  "description": "调拨来源工单ID（从哪个工单调出）"},
        {"field_id": "to_work_order_id", "data_type": "VARCHAR(50)", "name": "目标工单ID", "required": False,  "description": "调拨目标工单ID（调入到哪个工单）"},
        {"field_id": "from_location", "data_type": "VARCHAR(100)", "name": "来源仓库", "required": False,  "description": "来源仓库/位置"},
        {"field_id": "to_location", "data_type": "VARCHAR(100)", "name": "目标仓库", "required": False,  "description": "目标仓库/位置"},
        {"field_id": "from_wom_id", "data_type": "VARCHAR(50)", "name": "来源工单物料需求ID", "required": False,  "description": "调出工单物料需求ID（from_work_order的物料需求）"},
        {"field_id": "to_wom_id", "data_type": "VARCHAR(50)", "name": "目标工单物料需求ID", "required": False,  "description": "调入工单物料需求ID（to_work_order的物料需求）"},
        {"field_id": "quantity", "data_type": "FLOAT", "name": "调拨数量", "required": True,  "description": "调拨数量（实际转移的物料数量）"},
        {"field_id": "transfer_reason", "data_type": "VARCHAR(100)", "name": "调拨原因", "required": False,  "description": "调拨原因（如：缺料挪用/紧急调拨/仓库调整）"},
        {"field_id": "trigger_source", "data_type": "VARCHAR(50)", "name": "触发来源", "required": False,  "description": "触发来源（如：MRP运算/人工创建/系统自动）"},
        ...
        {"field_id": "status", "data_type": "VARCHAR(50)", "name": "状态", "required": False,  "description": "调拨单状态（枚举：已申请/已审批/执行中/已完成/已拒绝）"},
        {"field_id": "approved_by", "data_type": "VARCHAR(50)", "name": "批准人", "required": False,  "description": "审批人"},
        {"field_id": "note", "data_type": "VARCHAR(500)", "name": "备注", "required": False,  "description": "备注说明"},
    ],
    "work_calendar": [
        {"field_id": "calendar_id", "data_type": "VARCHAR(50)", "name": "日历ID", "required": True,  "description": "日历记录唯一标识符"},
        {"field_id": "calendar_date", "data_type": "DATE", "name": "日期", "required": True,  "description": "日历日期"},
        {"field_id": "work_center_id", "data_type": "VARCHAR(50)", "name": "工作中心ID", "required": True,  "description": "工作中心ID（外键关联work_center表）"},
        {"field_id": "shift_id", "data_type": "VARCHAR(50)", "name": "班次ID", "required": True,  "description": "班次唯一标识符"},
        ...
        {"field_id": "note", "data_type": "VARCHAR(200)", "name": "备注", "required": False,  "description": "备注说明"},
    ],
    "inventory": [
        {"field_id": "inventory_id", "data_type": "VARCHAR(50)", "name": "库存ID", "required": True,  "description": "库存记录唯一标识符"},
        {"field_id": "material_id", "data_type": "VARCHAR(50)", "name": "物料ID", "required": True,  "description": "物料唯一标识符"},
        {"field_id": "location", "data_type": "VARCHAR(100)", "name": "仓库位置", "required": False,  "description": "仓库/位置（如：主仓库/线边仓/成品仓）"},
    ...
    "inventory_transaction": [
        {"field_id": "transaction_id", "data_type": "VARCHAR(50)", "name": "事务ID", "required": True,  "description": "事务流水唯一标识符"},
        {"field_id": "material_id", "data_type": "VARCHAR(50)", "name": "物料ID", "required": True,  "description": "物料唯一标识符"},
        {"field_id": "transaction_type", "data_type": "VARCHAR(50)", "name": "事务类型", "required": True,  "description": "事务类型（枚举：入库/出库/调拨/盘盈/盘亏/预留/释放/调整）"},
        ...
        {"field_id": "related_document_type", "data_type": "VARCHAR(50)", "name": "关联单据类型", "required": False,  "description": "关联单据类型（如：WorkOrder/PurchaseOrder/Transfer）"},
        {"field_id": "related_document_id", "data_type": "VARCHAR(50)", "name": "关联单据ID", "required": False,  "description": "关联单据ID（根据related_document_type关联不同表）"},
        {"field_id": "from_work_order_id", "data_type": "VARCHAR(50)", "name": "来源工单ID", "required": False,  "description": "库存事务来源工单ID（出库时）"},
        {"field_id": "to_work_order_id", "data_type": "VARCHAR(50)", "name": "目标工单ID", "required": False,  "description": "库存事务目标工单ID（入库时）"},
        {"field_id": "transaction_time", "data_type": "DATETIME", "name": "事务时间", "required": True,  "description": "事务发生时间"},
        {"field_id": "description", "data_type": "VARCHAR(500)", "name": "事务说明", "required": False,  "description": "事务说明（详细描述本次库存变动原因）"},
        {"field_id": "created_by", "data_type": "VARCHAR(50)", "name": "创建者", "required": False,  "description": "创建人（如：SYSTEM/MRP/用户名）"},
    ],
    "finished_goods_inventory": [
        {"field_id": "fg_inv_id", "data_type": "VARCHAR(50)", "name": "成品库存ID", "required": True,  "description": "成品库存唯一标识符"},
        {"field_id": "product_id", "data_type": "VARCHAR(50)", "name": "产品ID", "required": True,  "description": "产品唯一标识符"},
        {"field_id": "location", "data_type": "VARCHAR(100)", "name": "仓库位置", "required": False,  "description": "仓库/位置（如：主仓库/线边仓/成品仓）"},
        {"field_id": "total_quantity", "data_type": "FLOAT", "name": "总数量", "required": False,  "description": "总数量（可用+预留）"},
        {"field_id": "available_quantity", "data_type": "FLOAT", "name": "可用数量", "required": False,  "description": "可用数量（可被分配的数量）"},
    ...
    "quality_inspection": [
        {"field_id": "inspection_id", "data_type": "VARCHAR(50)", "name": "检验ID", "required": True,  "description": "检验记录唯一标识符"},
        {"field_id": "inspection_type", "data_type": "VARCHAR(50)", "name": "检验类型", "required": True,  "description": "检验类型（枚举：IPQC过程质检/IQC来料检验/FQC成品检验/首件检验/完工检验）"},
        {"field_id": "wo_op_id", "data_type": "VARCHAR(50)", "name": "工单工序ID", "required": False,  "description": "工单工序唯一标识符"},
        {"field_id": "lot_id", "data_type": "VARCHAR(50)", "name": "批次ID", "required": False,  "description": "批次唯一标识符"},
        {"field_id": "machine_id", "data_type": "VARCHAR(50)", "name": "机台ID", "required": False,  "description": "机台唯一标识符"},
        {"field_id": "po_id", "data_type": "VARCHAR(50)", "name": "采购订单ID", "required": False,  "description": "采购订单唯一标识符"},
        {"field_id": "material_id", "data_type": "VARCHAR(50)", "name": "物料ID", "required": False,  "description": "物料唯一标识符"},
        {"field_id": "related_doc_type", "data_type": "VARCHAR(50)", "name": "关联单据类型", "required": False,  "description": "关联单据类型（枚举：WorkOrder/PurchaseOrder/MaterialTransfer）"},
        {"field_id": "related_doc_id", "data_type": "VARCHAR(50)", "name": "关联单据ID", "required": False,  "description": "关联单据ID（根据related_doc_type关联不同表）"},
        ...
        {"field_id": "result", "data_type": "VARCHAR(50)", "name": "结果", "required": False,  "description": "检验结果（枚举：合格/返工/报废/让步接收/待检验）"},
        {"field_id": "disposition", "data_type": "VARCHAR(200)", "name": "处置说明", "required": False,  "description": "处置说明（如何处理不合格品）"},
        {"field_id": "is_hold", "data_type": "BOOLEAN", "name": "是否Hold", "required": False,  "description": "是否冻结（True=批次被冻结，不可流转）"},
        {"field_id": "inspector", "data_type": "VARCHAR(50)", "name": "检验员", "required": False,  "description": "检验员（如：QC-AUTO/QC-张三）"},
        {"field_id": "note", "data_type": "VARCHAR(500)", "name": "备注", "required": False,  "description": "备注说明"},
    ],
    "schedule": [
        {"field_id": "schedule_id", "data_type": "VARCHAR(50)", "name": "排程ID", "required": True,  "description": "排程汇总唯一标识符"},
        ...
        {"field_id": "bottleneck_machine_id", "data_type": "VARCHAR(50)", "name": "瓶颈机台ID", "required": False,  "description": "瓶颈机台ID（负荷最高的机台）"},
        {"field_id": "bottleneck_work_center_id", "data_type": "VARCHAR(50)", "name": "瓶颈工作中心ID", "required": False,  "description": "瓶颈工作中心ID（负荷最高的工作中心）"},
    ...
    "machine_status_log": [
        {"field_id": "log_id", "data_type": "VARCHAR(50)", "name": "日志ID", "required": True,  "description": "日志唯一标识符"},
        {"field_id": "machine_id", "data_type": "VARCHAR(50)", "name": "机台ID", "required": True,  "description": "机台唯一标识符"},
        {"field_id": "status_time", "data_type": "DATETIME", "name": "状态时间", "required": True,  "description": "状态记录时间"},
        {"field_id": "status", "data_type": "VARCHAR(50)", "name": "状态", "required": True,  "description": "机台状态（枚举：在线/离线/维护中/故障/待机）"},
        {"field_id": "product_id", "data_type": "VARCHAR(50)", "name": "生产产品ID", "required": False,  "description": "当前加工产品ID（status=在线时有效）"},
        {"field_id": "running_wo_id", "data_type": "VARCHAR(50)", "name": "运行工单ID", "required": False,  "description": "运行中工单ID"},
        {"field_id": "running_task_id", "data_type": "VARCHAR(50)", "name": "运行任务ID", "required": False,  "description": "运行中任务ID"},
    ...
    "external_supply_chain_risk": [
        {"field_id": "risk_id", "data_type": "VARCHAR(50)", "name": "风险ID", "required": True,  "description": "风险事件唯一标识符"},
        {"field_id": "supplier_id", "data_type": "VARCHAR(50)", "name": "主要受影响供应商ID", "description": "风险事件的直接责任方或主要受影响方（1个）。如需记录多个关联供应商，使用SupplierRiskAssociation对象", "required": False},
        {"field_id": "customer_id", "data_type": "VARCHAR(50)", "name": "关联客户ID", "required": False,  "description": "客户唯一标识符"},
        {"field_id": "material_id", "data_type": "VARCHAR(50)", "name": "关联物料ID", "required": False,  "description": "物料唯一标识符"},
        {"field_id": "risk_category", "data_type": "VARCHAR(50)", "name": "风险类别", "description": "风险类别（枚举：natural_disaster自然灾害/geopolitical地缘政治/financial财务/quality质量/legal法律/operational运营）", "required": True},
        {"field_id": "risk_level", "data_type": "VARCHAR(20)", "name": "风险等级", "description": "风险等级（枚举：critical严重/high高/medium中/low低）", "required": True},
        ...
        {"field_id": "impact_scope", "data_type": "VARCHAR(50)", "name": "影响范围", "description": "影响范围（枚举：global全球/regional区域/local局部）", "required": False},
        {"field_id": "estimated_impact_days", "data_type": "INTEGER", "name": "预估影响天数", "required": False,  "description": "预估影响天数"},
        {"field_id": "affected_materials", "data_type": "TEXT", "name": "受影响物料", "description": "JSON数组格式", "required": False},
        {"field_id": "affected_products", "data_type": "TEXT", "name": "受影响产品", "description": "JSON数组格式", "required": False},
        ...
        {"field_id": "status", "data_type": "VARCHAR(20)", "name": "处理状态", "description": "风险处理状态（枚举：new新发现/analyzing分析中/mitigating缓解中/resolved已解决/ignored已忽略）", "required": False},
        {"field_id": "assigned_to", "data_type": "VARCHAR(50)", "name": "负责人", "required": False,  "description": "负责人（处理该风险的责任人）"},
        ...
        {"field_id": "keywords", "data_type": "TEXT", "name": "关键词", "description": "JSON数组格式", "required": False},
        {"field_id": "raw_content", "data_type": "TEXT", "name": "原始舆情内容", "required": False,  "description": "原始舆情内容（完整新闻/报告文本）"},
    ],
    "supplier_risk_association": [
        {"field_id": "id", "data_type": "INTEGER", "name": "自增ID", "required": False,  "description": "唯一标识符（主键）"},
        {"field_id": "supplier_id", "data_type": "VARCHAR(50)", "name": "供应商ID", "required": True,  "description": "供应商唯一标识符"},
        {"field_id": "risk_id", "data_type": "VARCHAR(50)", "name": "风险ID", "required": True,  "description": "风险事件唯一标识符"},
        {"field_id": "association_type", "data_type": "VARCHAR(50)", "name": "关联类型", "description": "关联类型（枚举：direct直接影响/indirect间接影响/potential潜在影响）", "required": False},
        {"field_id": "impact_level", "data_type": "VARCHAR(20)", "name": "影响程度", "description": "影响程度（枚举：critical严重/high高/medium中/low低，可与风险整体等级不同）", "required": False},
        {"field_id": "note", "data_type": "VARCHAR(500)", "name": "备注", "required": False,  "description": "备注说明"},
    ],
}
