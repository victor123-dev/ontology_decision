...
ALL_FIELDS = {
    ...
    "external_supply_chain_risk": [
        ...
        {"field_id": "risk_category", "data_type": "string", "name": "风险类别", "description": "风险类别（枚举：自然灾害/政治事件/财务风险/质量风险/法律风险/运营风险）", "required": True, "is_enum": True, "enum_values": ["自然灾害", "政治事件", "财务风险", "质量风险", "法律风险", "运营风险"]},
        ...
        {"field_id": "status", "data_type": "string", "name": "处理状态", "description": "风险处理状态（枚举：新发现/分析中/缓解中/已解决/已忽略）", "required": False, "is_enum": True, "enum_values": ["新发现", "分析中", "缓解中", "已解决", "已忽略"]},
